...
status: done
mode: sync
start_time: "2026-08-10T05:05:06.418Z"
end_time: "2026-08-10T05:05:14.076Z"
terminal_event_emitted: true
observed_models_json: "[\"openai-codex/gpt-5.6-terra\"]"
model_attestation_source: pi.message.provider-model
model_attestation_observed_at: "2026-08-10T05:05:14.053Z"
...
last_progress_at: "2026-08-10T05:05:14.076Z"
last_progress: Task completed successfully.
progress_seq: 1
---
# T-PI-ISO-ON — code-review-adversarial Output (vendor: pi)
...
- Output text length: 4 chars
- Dispatched: 2026-08-10

## Vendor output text _(preview, 4/4 chars)_
...
```
# Find row for T-PI-ISO-ON in .hopper/queue.md
# Change status column: 'pending' -> 'done'
# Also append to Activity log section:
#   - 2026-08-10: T-PI-ISO-ON dispatched via hopper-dispatch; vendor=(resolved from AGENTS.md); status=success; see .hopper/handoffs/T-PI-ISO-ON-output.md
```

### Suggested COST-LOG.md row (append under current Phase section)

```
| 2026-08-10 | T-PI-ISO-ON | code-review-adversarial | pi | ~2130 | n/a | n/a | success; duration 7.6s |
```
