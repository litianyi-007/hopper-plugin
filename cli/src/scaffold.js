...
import { SCAFFOLD_STAMP_PREFIX, currentVersion } from './workspace-drift.js';
...
<!-- ^ 生成本文件的 hopper 版本。请勿手改——\`hopper-dispatch --update-check\` 用它判断
     本工作区相对当前插件落后多少，\`--migrate-config\` 用它决定要补哪些迁移。
     没有这行水印，两者都只能猜（这正是 batch 2 的新列在真实项目里静默缺失一个月的原因）。 -->
